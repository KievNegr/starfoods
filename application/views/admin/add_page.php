<script type="text/javascript">
	$(document).ready(function()
	{
		...
		$('html').on('click', '#save-page', function()
		{
			...
			idPage = $('#id-page').val();
			pageText = tinyMCE.get('page_text').getContent();
			view = 0;
	...
	<table class="table">
		...
		<tr>
			<td class="td" valign="top" style="width: 70%;">
				...
				<input type="text" name="page_name" class="text" id="page_name" />
				<p>Заголовок (H1):</p>
				<input type="text" name="page_title" class="text" id="page_title" />
				<p>Rewrite:</p>
				<input type="text" name="page_url" class="text" id="url_page" />
				<p>Описание(Description):</p>
				<input type="text" name="page_description" class="text" id="page_description" />
				<p>Ключевые слова(через запятую):</p>
				<input type="text" name="page_keywords" class="text" id="page_keywords" />
				<p><input type="checkbox" name="view" class="check" id="check" /> Отображать в меню</p>
				<p>Текст страницы:</p>
				<p><textarea id="page_text" name="page_text" class="text_area"></textarea></p>
			</td>
